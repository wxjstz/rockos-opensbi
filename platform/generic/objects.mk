...
ifdef CONFIG_PLATFORM_SPECAL_ADDR
FW_TEXT_START=$(CONFIG_FW_TEXT_START)
FW_JUMP_ADDR=$(CONFIG_FW_JUMP_ADDR)
FW_JUMP_FDT_ADDR=$(CONFIG_FW_JUMP_FDT_ADDR)
FW_PAYLOAD_OFFSET=$(CONFIG_FW_PAYLOAD_OFFSET)
FW_PAYLOAD_FDT_ADDR=$(CONFIG_FW_PAYLOAD_FDT_ADDR)
else
